    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-10 ftco-animate">
                <h3 class="mb-4 billing-heading">Tambah Data</h3>
                <form action="/beranda" method="POST" enctype="multipart/form-data" class="billing-form">
                    @csrf
                    <div class="row align-items-end">
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="text" name="negara" class="form-control @error('negara') is-invalid @enderror" placeholder="Negara" autofocus autocomplete="off" value="{{old('negara')}}">
                            ...
                            <div class="form-group">
                                <textarea type="text" name="deskripsi" class="form-control ckeditor @error('deskripsi') is-invalid @enderror" placeholder="Deskripsi">{{old('deskripsi')}}</textarea>
